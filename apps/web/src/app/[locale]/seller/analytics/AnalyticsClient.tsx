...
export function AnalyticsClient({
    ...
    basePath = "/seller",
    pageTitle = "Analytics",
    pageDescription = "Signals from orders, payments, and fulfillment velocity."
                        ...
                        <div className="bg-white border border-slate-200/80 rounded-xl shadow-sm overflow-hidden">
                            <div className="px-6 py-4 border-b border-slate-100">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Link href={`${basePath}/orders`} className="text-xs font-semibold text-[#3B82F6] hover:text-[#2563EB] flex items-center gap-1">
