...
function WizardLayoutContent({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex flex-col min-h-full bg-[#F9F8F6]">
            {/* Wizard Header */}
            <header className="h-14 bg-white border-b border-slate-200 sticky top-0 z-40 flex items-center px-6 justify-between shadow-sm shrink-0">
                {/* Left: Return */}
                ...
                <div className="flex-1 flex justify-end items-center gap-4">
                    <span className="text-xs text-slate-400 font-medium hidden lg:block">
            ...
            {/* Main Content */}
            <main className="flex-1 relative flex flex-col p-6 sm:p-8 max-w-7xl mx-auto w-full">
                {children}
            </main>
