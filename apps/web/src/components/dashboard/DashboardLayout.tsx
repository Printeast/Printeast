    ...
    return (
        <div className="flex h-screen bg-background font-sans overflow-hidden text-foreground">
            ...
            <div className="flex flex-1 flex-col min-h-0">
                {!hideHeader && (
                    <header className="h-[72px] flex items-center justify-between px-8 flex-shrink-0 z-20 relative transition-all duration-500 border-b border-white/10" style={{
                        ...
                        <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none opacity-40">
                            <div
                                className="absolute top-[-100%] left-[-20%] w-[140%] h-[300%] bg-[radial-gradient(circle_at_50%_50%,rgba(37,99,235,0.08)_0%,transparent_50%)] animate-[spin_30s_linear_infinite] will-change-transform"
                            />
                        </div>
                    </div>
